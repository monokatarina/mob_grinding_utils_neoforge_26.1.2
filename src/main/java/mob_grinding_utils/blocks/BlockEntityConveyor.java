...
public class BlockEntityConveyor extends Block {
	...
	@Override
	public void entityInside(@Nonnull BlockState state, @Nonnull Level world, @Nonnull BlockPos pos, Entity entity, @Nonnull InsideBlockEffectApplier applier, boolean shouldTick) {
