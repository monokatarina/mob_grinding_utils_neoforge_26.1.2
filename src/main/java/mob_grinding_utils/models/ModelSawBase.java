...
public class ModelSawBase extends Model<Unit> {
	...
	public void renderBase(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int color) {
