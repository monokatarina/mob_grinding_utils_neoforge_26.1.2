...
public class ModelXPSolidifier extends Model<Unit> {
	...
	public void renderTank(PoseStack matrixStackIn, VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int color) {
