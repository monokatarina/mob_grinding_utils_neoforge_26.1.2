...
public class ModelSawBlade extends Model<Unit> {
	...
	public void renderBlade(@Nonnull PoseStack matrixStackIn, @Nonnull VertexConsumer bufferIn, int packedLightIn, int packedOverlayIn, int color) {
