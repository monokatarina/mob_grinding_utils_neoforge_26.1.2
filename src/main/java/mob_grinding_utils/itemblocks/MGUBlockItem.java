...
public class MGUBlockItem extends BlockItem {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull net.minecraft.world.item.Item.TooltipContext context, @Nonnull List<Component> tooltip, @Nonnull TooltipFlag flagIn) {
        for (int i = 1; i <= 6; i++) {
