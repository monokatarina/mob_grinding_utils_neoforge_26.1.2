...
public class BlockItemTank extends BlockItem {
	...
	public void appendHoverText(ItemStack stack, @Nonnull net.minecraft.world.item.Item.TooltipContext context, @Nonnull List<Component> list, @Nonnull TooltipFlag flag) {
