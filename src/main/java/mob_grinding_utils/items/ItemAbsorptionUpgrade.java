...
public class ItemAbsorptionUpgrade extends Item {
	...
	public void appendHoverText(@Nonnull ItemStack stack, @Nonnull net.minecraft.world.item.Item.TooltipContext context, List<Component> list, @Nonnull TooltipFlag flag) {
